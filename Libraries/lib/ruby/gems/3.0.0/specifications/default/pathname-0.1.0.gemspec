...
Gem::Specification.new do |s|
  ...
  s.files = ["anyolite/build/src_mri/ext/pathname/extconf.rb".freeze, "anyolite/build/src_mri/ext/pathname/lib/pathname.rb".freeze, "ext/pathname/extconf.rb".freeze]
