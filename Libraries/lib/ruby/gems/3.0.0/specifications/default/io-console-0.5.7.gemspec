...
Gem::Specification.new do |s|
  ...
  s.files = ["anyolite/build/src_mri/ext/io/console/extconf.rb".freeze, "anyolite/build/src_mri/ext/io/console/lib/console/size.rb".freeze, "ext/io/console/extconf.rb".freeze]
