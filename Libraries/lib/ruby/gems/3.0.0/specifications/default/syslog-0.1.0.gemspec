...
Gem::Specification.new do |s|
  ...
  s.files = ["anyolite/build/src_mri/ext/syslog/extconf.rb".freeze, "anyolite/build/src_mri/ext/syslog/lib/syslog/logger.rb".freeze, "ext/syslog/extconf.rb".freeze]
