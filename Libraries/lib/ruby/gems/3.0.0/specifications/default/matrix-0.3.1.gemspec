...
Gem::Specification.new do |s|
  ...
  s.files = ["anyolite/build/src_mri/lib/matrix.rb".freeze, "anyolite/build/src_mri/lib/matrix/eigenvalue_decomposition.rb".freeze, "anyolite/build/src_mri/lib/matrix/lup_decomposition.rb".freeze, "anyolite/build/src_mri/lib/matrix/version.rb".freeze]
